...
import workoutMonkeyAnimation from "../../animations/scooter.json";
import type {
  LottieDataSource,
  LottieUrlSource,
...
<template>
  <main class="demo-shell">
    <section class="hero">
      ...
      <p class="lede">
        This demo exercises the Vue 3 library directly from local source, using
        the new <code>ready</code> event and component ref controls.
      </p>
    </section>
    ...
    <section class="panel-grid">
      <article class="panel">
        <div class="panel-header">
          ...
          <button class="ghost-button" type="button" @click="swapRemoteSource">
            Swap remote source
          </button>
        </div>
        <VueLottiePlayer
